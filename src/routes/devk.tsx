...
// --- Helper Components ---
const inputCls = "bg-[#161b22] border-[#30363d] text-white focus:border-[#22d3ee]";

function PageTitle({ icon, title, subtitle }: { icon: string; title: string; subtitle: string }) {
  return (
    <div>
...
function Card({ title, icon, children }: { title: string; icon: React.ReactNode; children: React.ReactNode }) {
  return (
    <div className="bg-[#0d1117] border border-[#30363d] rounded-xl overflow-hidden">
      <div className="px-4 py-3 border-b border-[#30363d] flex items-center gap-2 bg-[#161b22]/50">
        {icon}
  ...
  return (
    <div className="bg-[#0d1117] border border-[#30363d] rounded-xl p-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-xs text-[#8b9ab0]">{label}</p>
      ...
      {[1, 2, 3].map((i) => (
        <div key={i} className="flex items-center gap-3 py-2">
          ...
          <div className="flex-1">
            <div className="h-4 bg-[#21262d] rounded w-32 animate-pulse" />
            <div className="h-3 bg-[#21262d] rounded w-20 mt-1 animate-pulse" />
          </div>
        </div>
      ))}
    </>
