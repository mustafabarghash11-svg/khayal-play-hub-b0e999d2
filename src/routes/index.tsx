...
function Home() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* Games */}
      <section id="games" className="py-24 px-6 max-w-7xl mx-auto scroll-mt-20">
      ...
      {/* Features */}
      <section id="features" className="py-24 px-6 bg-card/30 border-y border-border scroll-mt-20">
      ...
      {data.customSections.map((s) => (
        <div key={s.id} className="scroll-mt-20"><CustomSectionView section={s} /></div>
      ))}
